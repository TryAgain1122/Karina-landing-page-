...
const Discography = () => {
  ...
  useEffect(() => {
    const timeUpadate = audioRef.current;
          ...
          {discography.map((album, index) => (
            <div
              ...
              className={`group relative rounded-3xl overflow-hidden cursor-pointer transform transition-all duration-500 shadow-xl shadow-pink-200/30
                  ${currentTrack === album.preview ? "scale-105 shadow-pink-300/50" : "hover:scale-105 hover:shadow-pink-300/50"}`}
            >
              {/* Album Cover */}
              <div className="relative h-80">
                ...
                <div
                  ...
                  onClick={(e) => { e.stopPropagation(); playPreview(album.preview); }}
                >
